 ...
 */
final class Version20240204190000 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE SEQUENCE dmarc_seen_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        ...
        $this->addSql('CREATE SEQUENCE smtptls_seen_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        ...
        $this->addSql('CREATE TABLE dmarc_seen (id INT NOT NULL, report_id INT NOT NULL, user_id INT NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE smtptls_reports (id INT NOT NULL, begin_time TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, end_time TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, organisation VARCHAR(255) NOT NULL, contact_info VARCHAR(255) NOT NULL, external_id VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE smtptls_seen (id INT NOT NULL, report_id INT NOT NULL, user_id INT NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('ALTER TABLE dmarc_seen ADD CONSTRAINT FK_40293B424BD2A4C0 FOREIGN KEY (report_id) REFERENCES dmarc_reports (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE dmarc_seen ADD CONSTRAINT FK_40293B42A76ED395 FOREIGN KEY (user_id) REFERENCES users (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        ...
        $this->addSql('ALTER TABLE smtptls_seen ADD CONSTRAINT FK_6AAFE3E94BD2A4C0 FOREIGN KEY (report_id) REFERENCES smtptls_reports (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE smtptls_seen ADD CONSTRAINT FK_6AAFE3E9A76ED395 FOREIGN KEY (user_id) REFERENCES users (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP SEQUENCE dmarc_seen_id_seq CASCADE');
        ...
        $this->addSql('DROP SEQUENCE smtptls_seen_id_seq CASCADE');
        ...
        $this->addSql('ALTER TABLE dmarc_seen DROP CONSTRAINT FK_40293B424BD2A4C0');
        $this->addSql('ALTER TABLE dmarc_seen DROP CONSTRAINT FK_40293B42A76ED395');
        ...
        $this->addSql('ALTER TABLE smtptls_seen DROP CONSTRAINT FK_6AAFE3E94BD2A4C0');
        $this->addSql('ALTER TABLE smtptls_seen DROP CONSTRAINT FK_6AAFE3E9A76ED395');
